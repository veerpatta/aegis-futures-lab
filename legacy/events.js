...
].map(([name,time,publisher,note])=>({name,time,publisher,note}));
...
module.exports = async function handler(req,res){
  ...
  res.status(200).json({
    ...
    limitation:'Unscheduled events and newly announced Federal Reserve speeches require a licensed real-time calendar.',
    events
  });
};
