...
export function researchCodeHash():string {
  const paths=[...sources("lib/strategies"),...sources("lib/backtest"),...sources("lib/costs"),...sources("lib/indicators"),...sources("lib/time"),...sources("lib/market"),...sources("lib/paper"),...sources("lib/validation"),"lib/types.ts","scripts/engine/regime.ts","scripts/engine/research-observer.ts","scripts/engine/paper-broker.ts","scripts/engine/research-code.ts"];
